    ...
    content: (
      <div style={{ padding: '2vw 5vw' }}>
        <p>
          ...
          HL7®(Health Level 7) FHIR® (Fast Healthcare Interoperability Resources)與IHE(Integrating the Healthcare
          Enterprise)等，發展在地化的醫療健康資訊互通聯測工作。以 「標準-實作-聯測-驗證」
    ...
    content: (
      <div style={{ padding: '2vw 5vw' }}>
        <ul style={{ margin: 0, padding: 0 }}>
          ...
          <li>
            聯測期間，參與者與其他系統進行連線測試，用來驗證開發的產品與系統符合國際標準規範，在聯測時如果遇到問題亦可在短時間內修正不符合格的項目。聯測活動使用測試工具來驗證數萬筆交易紀錄，且由中立的「聯測督察員(Monitor)」來評斷結果。
          </li>
          <li>
            聯測結束後，可透過聯測結果陣列(Connectathon Results
            Matrix)查看。透過聯測活動來達到產業之間的數據交換與互助，以合作的方式相互發展具備全球市場競爭力之產品。
            <center>
              <img src={p3} Width={'70%'} />{' '}
            </center>
            <br />
        ...
        <ul>
          ...
          <li>每年廠商參加聯測，以證明系統功能符合規範(conformance)</li>
          <li>從2020年開始，從四大領域擴展到多個領域，截至今天為止，共涵蓋10領域，讓不同廠商開發的系統能夠互通。</li>
          <li>
            透過照護提供者（Care providers）與IT從業人員以及廠商共同合作(Coordinate)
    ...
    content: (
      <div style={{ padding: '2vw 0' }}>
        ...
        <ul style={{ marginBottom: '2rem' }}>
          ...
          <li>可註記已通過聯測的廠商最做為日後審查之參考(過濾蟑螂公司)</li>
        </ul>
        <div>
        ...
        <h4>通用優點</h4>
        <ul style={{ marginBottom: '2rem' }}>
          <li>可將產品註冊至聯測結果陣列(Connectathon Results Matrix)</li>
        ...
        <ul style={{ marginBottom: '2rem' }}>
          ...
          <li>提供新創公司一個很好的舞台</li>
          <li>參加的廠商越多，對產業鏈供給越緊密，進而讓病人以及醫護人員帶來更大的利益</li>
        </ul>
        <h3 style={{ margin: ' 0 0 2vh' }}>參加聯測對於學習醫學資訊標準(例如:DICOM、HL7)的好處</h3>
        <ul style={{ marginBottom: '2rem' }}>
          <li>提供參加者學習、開發、以及測試FHIR規範 (Implementation Guide)</li>
          <li>
            開發者之間 面對面(Face to face)使用標準化DICOM、HL7 Message、以及FHIR介面(Interface)
