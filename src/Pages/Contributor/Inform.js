...
const Mem = [
  ...
  },
  {
    ...
    Img: wg8_2,
    Position: '成員',
    Name: '彭群芳 | 國泰金控數位發展數據暨科技發展中心 資深商業策略規劃師',
    Tollger: (
      <>
        <b>1. 學歷：</b>
        <ul>
        ...
        <b>2.　現職：</b>
        <ul>
          <li>國泰金控數位發展數據暨科技發展中心 資深商業策略規劃師</li>
        </ul>
  ...
  },
  {
    ...
    Tollger: (
      <>
        ...
        <ul>
          <li>
            十年以上醫學中心醫療影像儲傳系統(PACS)執行與管理經驗，醫療儀器、外圍科室報告系統介接醫療資訊系統經驗豐富
          </li>
          <li>病理影像數位化推行及各臨床單位影像人工智慧專案資料執行與落地整合，實務經驗豐富</li>
          <li>自行開發健保署影像共享機制程式，為全國首間自動化上傳醫院 </li>
          <li>MI-TW 2021 Connectathon督察員（Monitor） </li>
          <li>MI-TW 2022 Connectathon督察員 (Monitor)</li>
        </ul>
        <b>4. 簡介：</b>
        <ul>
