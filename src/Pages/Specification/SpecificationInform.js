...
const List = [
  ...
  },
  {
    ...
    content: (
      <div>
        <p style={{ textIndent: '2em' }}>
          聯測將使用架設的IHE Gazelle (以下簡稱Gazelle) 。在Gazelle聯測系統中，包含測試整合規範(Integration
    ...
    content: (
      <div>
        <p style={{ textIndent: '2em' }}>
          ...
          Script)，每個測試案例定義會加入該角色對應要連線測試的受測角色，依據標準規範分成no peer以及peer to
  ...
  },
  {
    ...
    content: (
      <div>
        <p style={{ textIndent: '2em' }}>
          聯測根據性質區分三個等級。Level I為基本能力驗證，系統需根據各賽道的測試情境(Scenario)的測試腳本(Test
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <ul style={{ margin: '0' }}>
          <li>
            實體面對面聯測者: 參加者連接聯測區域網路後，經過網路設定，將交易連結導向Gazelle
